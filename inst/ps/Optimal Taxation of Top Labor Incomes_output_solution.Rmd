...
ps.dir =  'D:/libraries/RTutorTopIncomeTaxation/RTutorTopIncomeTaxation/inst/ps' # set to the folder in which this file is stored
ps.file = 'Optimal Taxation of Top Labor Incomes_output_solution.Rmd' # set to the name of this file
...
```{r "1_1_US_evidence_-_Graphical_approach_"}
...
```{r "1_1_US_evidence_-_Graphical_approach__2"}
...
```{r "1_1_US_evidence_-_Graphical_approach__3"}
...
```{r "1_1_US_evidence_-_Graphical_approach__4"}
...
```{r "1_1_US_evidence_-_Graphical_approach__5"}
...
```{r "1_1_US_evidence_-_Graphical_approach__6"}
...
```{r "1_1_US_evidence_-_Graphical_approach__7"}
...
```{r "1_2_US_evidence_-_Simple_estimations__8"}
...
```{r "1_2_US_evidence_-_Simple_estimations__9"}
...
```{r "1_2_US_evidence_-_Simple_estimations__10"}
...
```{r "1_2_US_evidence_-_Simple_estimations__11"}
...
```{r "1_2_US_evidence_-_Simple_estimations__12"}
# assign e_estimate_n
...
```{r "1_2_US_evidence_-_Simple_estimations__13"}
...
```{r "1_3_US_evidence_-_Linear_regressions__14"}
# First, we load our data again:
US.data = read.table("usdata.csv")
...
```{r "1_3_US_evidence_-_Linear_regressions__15"}
...
```{r "1_3_US_evidence_-_Linear_regressions__16"}
# load the required package from the library:
library(regtools)
...
```{r "1_3_US_evidence_-_Linear_regressions__17"}
...
```{r "1_3_US_evidence_-_Linear_regressions__18"}
...
```{r "1_3_US_evidence_-_Linear_regressions__19"}
# load the required package from the library:
library(sandwich)
...
```{r "1_3_US_evidence_-_Linear_regressions__20"}
...
```{r "2_1_International_evidence_-_Top_income_shares__21"}
...
```{r "2_1_International_evidence_-_Top_income_shares__22",results='asis'}
...
```{r "2_1_International_evidence_-_Top_income_shares__23"}
...
```{r "2_1_International_evidence_-_Top_income_shares__24"}
...
```{r "2_1_International_evidence_-_Top_income_shares__25"}
...
```{r "2_1_International_evidence_-_Top_income_shares__26"}
...
```{r "2_2_International_evidence_-_Economic_growth__27"}
...
```{r "2_2_International_evidence_-_Economic_growth__28"}
...
```{r "2_2_International_evidence_-_Economic_growth__29"}
...
```{r "2_2_International_evidence_-_Economic_growth__30"}
...
```{r "2_2_International_evidence_-_Economic_growth__31"}
Int.data = mutate(group_by(Int.data, country), 
...
```{r "2_2_International_evidence_-_Economic_growth__32",results='asis'}
...
```{r "3_1_Theory_-_Studying_a_model__33"}
...
```{r "3_1_Theory_-_Studying_a_model__34"}
...
```{r "3_2_Theory_-_Developing_a_function__35"}
...
```{r "3_2_Theory_-_Developing_a_function__36"}
pq.formula(2, -3)
```
...
```{r "3_2_Theory_-_Developing_a_function__37"}
...
```{r "3_2_Theory_-_Developing_a_function__38"}
...
```{r "3_2_Theory_-_Developing_a_function__39"}
