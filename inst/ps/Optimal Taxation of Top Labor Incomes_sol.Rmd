...
#setwd("C:/Users/Jonas/Desktop/Bachelorarbeit/Problem Set")
...
#< info "googleVis"
The *googleVis* package offers the possibility to visualize *R* data frames with interactive Google Charts. The output of a *googleVis* function is html code which can be opened in a new window in your browser or embedded into existing html documents and websites. It is a great tool to dive into data and in many cases exceeds the possibilities of visualization of information that more common ways to plot provide by far.  
...
The social marginal welfare weight on individual $i$ is defined as $g_i = G'(u_i)u_{ci} / p$. For top bracket income earners, we assume that this is on average zero. This allows us to obtain an upper bound on the optimal top tax rate. But, as we will discuss later, we can also integrate a positive social welfare weight $g$ on marginal consumption of top bracket earners.
#>
